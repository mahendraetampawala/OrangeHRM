...
public class UserManagement {
	...
	@And("user enters the emaployee name as{string}")
	public void user_enters_the_emaployee_name_as(String EmployeeName) {
		
	}
	
	@And("user selects the status as{string}")
	public void user_selects_the_status_as(String Status) {
